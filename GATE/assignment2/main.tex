...
\begin{enumerate}
    ...
    \end{enumerate}
    \end{multicols}
    \subsection{Statement for Linked Answer Questions $54$ and $55$:} Consider the following circuit
    \begin{figure}[!ht]
\centering
\resizebox{6cm}{!}{%
\begin{circuitikz}
...
\node [font=\small] at (4,12.75) {\textbf{V\brak{in}}};
\node [font=\small] at (6.5,13.5) {\textbf{10k$\Omega$}};
\node [font=\small] at (7,11.5) {\textbf{1000pF}};
\node [font=\small] at (15,12.5) {\textbf{V\brak{out}}};
\node [font=\small] at (13.25,10.75) {\textbf{1k$\Omega$}};
\node [font=\small] at (13.25,8) {\textbf{2k$\Omega$}};
\end{circuitikz}
}%
...
\end{figure}
    ...
    \begin{multicols}{4}
        ...
        \end{enumerate}
    \end{multicols}
    \section{\textbf{General Aptitude \brak{\text{GA}} Questions}}
